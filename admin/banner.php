...
$banners = $conn->query("SELECT * FROM banners ORDER BY uploaded_at DESC");
...
$page_content = '
    ...
    <form method="POST" enctype="multipart/form-data" 
        ...
        <div class="form-group">
            ...
            <input type="file" id="bannerInput" name="banner" accept="image/*" class="form-control-file" required>
        </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm" style="height:350px;">
                    ...
                    <div class="container" style="height:80%;">
                        <img src="../uploads/banner/'. $img .'" class="card-img mt-3" style="object-fit:cover; height:100%;">
                    </div>
