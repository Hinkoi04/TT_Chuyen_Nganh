...
<nav class="navbar navbar-expand-lg py-3 shadow-lg sticky-top bg-pri">
    <div class="container">
        ...
        <a class="navbar-brand font-weight-bold" href="../user/index.php">
            <img src="../uploads/logo.png" style="width:100px;height:50px">
        </a>
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            ...
            <form class="form-inline mx-auto" action="../user/search.php" method="get">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light rounded-pill mx-2" href="../user/cart.php">
                ...
                <?php if (!empty($_SESSION['user_id'])): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-danger rounded-pill bg-primary"
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light rounded-pill" href="../user/login.php">
